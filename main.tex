...
\cvitem{Opis}{ Projekt integracyjny wykonywany według koncepcji SOA WebService}
\cvitem{Zadania}{
	\begin{itemize}
...
\cvitem{Pracodawca}{Asseco Poland}
\cvitem{Technologie}{ JAVA, SOA, Enterprise Architect API ,SOAP WebService}
\cvitem{Opis}{ Projekt integracyjny wykonywany według koncepcji SOA WebService - kompleksowa platforma wspierająca proces leczenia pacjentów. }
\cvitem{Zadania}{
\begin{itemize}
...
\section{Narzędzia wspomagające procesy wytwarzania aplikacji}
